            ...
            <div class="row">
                <div class="col">
                    <div style="background-color: #74d0f6;width:100%">
                        <h4 class="d-xl-flex mr-auto" style="color: #ffffff;font-family: Roboto, sans-serif;padding:20px"><strong>Defesas a participar</strong></h4>
                    </div>
                    <main>
                        <div class="container-fluid" role="alert" style="width: 100%;padding-top: 8px;padding-bottom: 8px;">
                            <div class="mensagem">
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: #3a3a3b;">Participantes<br></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($participante as $defesa)
                                    <tr>
                                        <td style="color: #3a3a3b;">{{$loop->index + 1}}</td>
                                        <td class="d-flex align-items-center" style="color: #3a3a3b;min-width:200px"><img class="rounded-circle" src="/ficheiros/estudantes/fotos/{{$defesa->foto}}" width="40px" style="margin-right: 10px;" height="40px">{{$defesa->autor}}</td>
                                        <td style="color: #3a3a3b;"><a style="color:#2390be;" href="/defesa/showdepois/{{ $defesa->id }}">{{$defesa->tema}}</a></td>
                                        ...
                                        <td>
                                            <div class="col d-flex align-items-start align-content-start">
                                                <form method="post" action="/defesa/leave/{{ $defesa->id }}">
                                                    @csrf
                                                    @method("DELETE")
                                                    <button class="btn btn-sm d-flex align-items-center" type="submit" style="background-color: #f51616;color: rgb(243,246,248);margin-right: 10px;margin-top: 6px;"><ion-icon name="trash-outline"></ion-icon>&nbsp;Não participar</button>
                                                </form>
