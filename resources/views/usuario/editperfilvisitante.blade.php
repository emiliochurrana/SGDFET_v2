...
<section style="padding: 20px;">
    ...
    <div class="container border rounded shadow" style="max-width: 100%;padding-right: 0px;padding-left: 0px;">
        <h3 style="color: #3ba2dc;margin-top: 20px;margin-left: 20px;margin-bottom: 0px;">{{$visitante->userVisitante->name}}</h3>
    ...
    <div class="container-fluid" role="alert" style="width: 100%;padding-top: 8px;padding-bottom: 8px;">
        ...
        <form style="width: 100%;padding: 30px;padding-top: 10px;" role="form" method="post" action="/usuario/updateperfilvisitante/{{$visitante->userVisitante->id}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-row justify-content-center align-items-center">
                <div class="col-12 col-md-5 col-lg-4 col-xl-3 d-flex justify-content-center">
                    <label class="col-form-label d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="500" style="padding: 5px;">
                        ...
                        <img class="rounded-circle shadow-lg img-perfilver" src="/ficheiros/visitantes/fotos/{{$visitante->foto}}">
                    </label>
                </div>
                <div class="col">
                    <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center" style="width: 100%;">
                        ...
                        <input class="shadow form-control" value="{{$visitante->userVisitante->name}}" type="text" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500" name="name">
                    </div>
                    ...
                    <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                        <label style="width: 230px;color: #000000;">Nome do usuario</label>
                        <input class="shadow form-control" value="{{$visitante->userVisitante->username}}" type="text" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500" name="username">
                    </div>
                    <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                        <label style="width: 230px;color: #000000;">Email</label>
                        <input class="shadow form-control" value="{{$visitante->userVisitante->email}}" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500" type="txet" name="email">
                    </div>
                </div>
            </div>
