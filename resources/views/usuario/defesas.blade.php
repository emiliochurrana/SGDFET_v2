            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-hover-animate="pulse" href="{{('/monografias')}}" style="color: rgb(255,255,255);font-size: 16px;">Monografias</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-white" href="{{('/monografias')}}" style="font-size:16px;">Monografias</a>
                        </li>
                        <li class="nav-item" role="presentation">
...
<section>
    <div class="container" style="max-width: 100%;background-image: url(&quot;../img/fundo3.png&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;padding-bottom: 250px;padding-top:0px;margin-top:50px">
        <main>
    ...
    <div class="container-fluid" role="alert" style="width: 100%;padding-top: 8px;padding-bottom: 8px;">
        ...
        <div class="row d-xl-flex conteiner-shadow" style="margin-right: 10px;margin-left: 10px;padding-bottom: 20px;margin-top: 20px;">
            ...
            <div class="col-12 col-xl-12 offset-3 offset-xl-0 d-inline-flex d-sm-inline-flex d-md-inline-flex d-lg-inline-flex d-xl-inline-flex m-auto m-sm-auto m-md-auto m-lg-auto justify-content-xl-end m-xl-auto" style="padding-top: 20px;padding-bottom: 100px;">
                <form class="d-inline-flex d-sm-inline-flex d-md-inline-flex d-lg-inline-flex d-xl-inline-flex m-sm-auto m-md-auto m-lg-auto m-xl-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="/defesas" enctype="multipart/form-data" style="padding-bottom: 0px;padding-top: 0px;max-width: 200%;min-width: 50%;">
                    <div class="input-group dataTables_filter" id="dataTable_filter">
                        <input style="padding-right:20px;height: 40px;" class=" shadow-lg form-control form-control-sm border-0 small" id="search" type="search" aria-controls="dataTable" placeholder="Pesquisar defesa pelo nome ..." name="search" autocomplete="on">
                        ...
                        <section class="card-section-imagia" style="padding-top: 15px;padding-bottom: 10px;background-color: rgba(241,241,241,0);">
                            <div class="container" style="padding-right: 0px;padding-left: 0px;">
                                <div class="row" style="margin: 0px;padding: 20px;padding-right: 10px;padding-left: 10px;">
                                            ...
                                            <div class="card-imagia">
                                                <div class="front-imagia">
                                                    ...
                                                    <div class="content-imagia defesa-front">
                                                        ...
                                                        <p class="align-items-center text-titulo"><ion-icon name="book" style="color: #68c7ef;"></ion-icon>&nbsp;<strong class="text-titulo-1"> Tema:</strong> {{$defesa->tema}}</p>
                                                        <p class="align-items-center text-titulo"><ion-icon name="person" style="color: #68c7ef;"></ion-icon>&nbsp;<strong class="text-titulo-1"> Supervisor:</strong> {{$defesa->supervisor}}</p>
                                                        <p class="align-items-center text-titulo"><ion-icon name="book" style="color: #68c7ef;"></ion-icon>&nbsp;<strong class="text-titulo-1"> Curso:</strong> {{$defesa->curso}}</p>
                                                        <p class="align-items-center text-titulo"><ion-icon name="calendar" style="color: #68c7ef;"></ion-icon>&nbsp;<strong class="text-titulo-1"> Data:</strong> {{date('d/m/y', strtotime($defesa->data))}}</p>
                                                        <p class="align-items-center text-titulo"><ion-icon name="time" style="color: #68c7ef;"></ion-icon>&nbsp;<strong class="text-titulo-1"> Hora:</strong> {{date('h:i', strtotime($defesa->hora))}}</p>
                                                    </div>
                                                ...
                                                <div class="back-imagia">
                                                    <div class="content-imagia content-back-imagia">
                                                        <div class="content-imagia defesa-back">
                                                            ...
                                                            <p class="d-flex align-items-center"><i class="fas fa-users"></i>&nbsp;<strong class="text-titulo"> {{count($defesa->participanteDefesa)}} Participantes</strong></p>
                                                    ...
                                                    <div class="footer-imagia">
                                                        <div class="social-imagia text-center">
                                                            @if(auth()->user())
                                                            <a class="btn btn-sm border rounded" type="button" href="/defesa/showdepois/{{$defesa->id}}" style="background-color: #16e8f5;font-family: Roboto, sans-serif;font-size:14px;">Saber mais</a>
                                                            @else
                                                            <a class="btn btn-sm border rounded" type="button" href="/defesa/showantes/{{$defesa->id}}" style="background-color: #16e8f5;font-family: Roboto, sans-serif;font-size:14px;">Saber mais</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    @endforeach
                                    <div class="container-fluid">
                                        @if(count($defesas) == 0 && $search)
                                        <p class="msg" style="color:#ffffff;"><Strong>Não foi possivel encontrar nenhuma defesa com o autor {{$search}}!</Strong><a style="font-size:16px" href="/defesas"> Ver Todas defesas</a></p>
                                        @elseif(count($defesas) == 0)
                                        <p class="msg"><Strong>Não há defesas disponiveis</Strong></p>
                                        @endif
                                    </div>
                                </div>
                            </div>
