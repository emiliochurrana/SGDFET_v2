                        ...
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-white" role="menu">
                                    ...
                                    <a class="dropdown-item" role="presentation" data-bs-hover-animate="pulse" href="{{('/participacoes')}}" style="color: rgb(90,161,220);">Participações</a>
                                </div>
                            </li>
                            <li class="nav-item" role="presentation">
    ...
    <section style="padding: 20px;">
        ...
        <div class="container border rounded shadow" style="max-width: 100%;padding-right: 0px;padding-left: 0px;">
            <h3 style="color: #3ba2dc;margin-top: 20px;margin-left: 20px;margin-bottom: 0px;">{{$estudante->userEstudante->name}}</h3>
            ...
            <main>
                ...
                <div class="container-fluid" role="alert" style="width: 100%;padding-top: 7px;padding-bottom: 7px;">
                    <div class="mensagem-error">
            ...
            <form style="width: 100%;padding: 30px;padding-top: 10px;" role="form" method="post" action="/usuario/updateperfilestudante/{{$estudante->userEstudante->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-row justify-content-center align-items-center">
                    <div class="col-12 col-md-5 col-lg-4 col-xl-3 d-flex justify-content-center">
                        <label class="col-form-label d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="500" style="padding: 5px;">
                            ...
                            <img class="rounded-circle shadow-lg img-perfilver" src="/ficheiros/estudantes/fotos/{{$estudante->foto}}">
                        </label>
                    </div>
                    <div class="col">
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center" style="width: 100%;">
                            <label style="color: #000000;width: 230px;">Nome</label>
                        ...
                        <!-- <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <input class="shadow form-control" value="" type="text" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500" name="username">
                        </div>-->
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                ...
                <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center" style="margin-top: 10px;margin-bottom: 10px;">
                    ...
                    <input class="shadow form-control" style="margin-right: 20px;margin-bottom: 10px;" value="{{$estudante->userEstudante->email}}" type="email" data-aos="zoom-in-right" name="email" data-aos-duration="500" data-aos-delay="500">
                ...
                <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center" style="margin-bottom: 10px;">
                    <label style="margin-right: 10px;width: 230px;color: #000000;">Nova senha</label>
                    <input class="shadow form-control" type="password" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500" name="password" style="margin-right: 20px;margin-bottom: 10px;">
                    <label style="color: #000000;margin-right: 10px;width: 350px;">Confirmar Password</label>
                ...
                <div class="form-group" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500">
                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <input value="{{$dado->declaracao_nota}}" type="file" accept="application/pdf" name="declaracao_nota">{{$dado->declaracao_nota}}
                        </span>
                    ...
                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <span class="fileinput-exists">Change</span>
                            <input value="{{$dado->bi}}" type="file" accept="application/pdf" name="bi">{{$dado->bi}}
                        </span>
                ...
                <div class="form-group" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500">
                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <span class="fileinput-exists">Change</span>
                            <input value="{{$dado->monografia}}" type="file" accept="application/pdf" name="monografia">{{$dado->monografia}}
                        </span>
                ...
                <div class="form-group" data-aos="zoom-in-right" data-aos-duration="500" data-aos-delay="500">
                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <span class="fileinput-exists">Change</span>
                            <input value="{{$dado->curriculum}}" type="file" accept="application/pdf" name="curriculum">{{$dado->curriculum}}
                        </span>
                ...
                <div class="form-group d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end">
                    ...
                    <a class="btn btn-sm d-flex align-items-center text-white shadow btn-cancelar shadow-lg" href="/usuario/perfilestudante/{{auth()->user()->id}}" type="button"><ion-icon name="cancel"></ion-icon>Cancelar</a>
                </div>
            </form>
        </div>
    </section>
