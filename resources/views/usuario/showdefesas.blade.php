                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-white" data-bs-hover-animate="pulse" href="{{('/inicio')}}" style="font-size: 16px;">Inicio</a>
                        </li>
    ...
    <div class="container border rounded shadow" style="margin: 0px;padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
        ...
        <div class="row" style="padding-top: 5px;padding-bottom: 20px;padding-right: 20px;padding-left: 20px;">
            ...
            <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;"><i class="fas fa-home" style="color: #68c7ef;"></i>&nbsp;<strong style="color: #68c7ef;"> Sala:</strong> {{$defesas->sala}}</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;"><i class="fa fa-calendar" style="color: #68c7ef;"></i>&nbsp;<strong style="color: #68c7ef;">Data:</strong> {{date('d/m/y', strtotime($defesas->data))}}</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;"><i class="fas fa-clock" style="color: #68c7ef;"></i>&nbsp;<strong style="color: #68c7ef;">Hora:</strong> {{date('h:i', strtotime($defesas->hora))}}</p>
