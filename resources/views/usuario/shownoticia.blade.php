        ...
        <div class="container border rounded shadow" style="padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
            ...
            <div class="row no-gutters text-justify" style="padding-top: 10px;padding-bottom: 5px;max-width: 100%;padding-left: 40px;padding-right: 40px;">
                <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;padding-bottom:30px;">
                    <img class="rounded img-fluid" style="background-size: cover;" src="/ficheiros/noticias/{{$noticias->foto}}" width="300px" height="300px">
                </div>
                <div class="col" style="height: 100%;padding-bottom: 0px;">
                    <h5 data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-family: Roboto, sans-serif;color: #000000;"><i class="fas fa-book-open" style="color: #68c7ef;font-size: 18px;"></i>&nbsp;<strong style="color:#68c7ef">Titulo:</strong> {{$noticias->titulo}}</h5>
