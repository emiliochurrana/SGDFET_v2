    ...
    <div class="container border rounded shadow" style="padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
        <div class="row" style="padding-top: 20px;padding-bottom: 0px;">
            <div class="col-xl-12 offset-xl-0">
                <h2 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #3ba2dc;margin-left: 20px;">Detalhes da noticia</h2>
                <hr style="background-color: #3ba2dc;margin-top: 5px;">
            </div>
        </div>
        <div class="row no-gutters text-justify" style="padding-top: 10px;padding-bottom: 5px;max-width: 100%;padding-left: 40px;padding-right: 40px;">
            <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;"><img class="rounded img-fluid" style="background-size: cover;" src="assets/img/img-1.jpg" width="300px" height="300px"></div>
            <div class="col" style="height: 100%;padding-bottom: 0px;">
                <h1 data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-family: Roboto, sans-serif;color: #000000;font-weight: bold;"><i class="fas fa-book-open" style="color: #68c7ef;font-size: 18px;"></i>&nbsp;Titulo:</h1>
                ...
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;font-family: Roboto, sans-serif;">
                    ...
                    <a class="text-primary" href="#" target="_blank" style="font-size: 16px;">aqui</a>
                </p>
            </div>
        </div>
