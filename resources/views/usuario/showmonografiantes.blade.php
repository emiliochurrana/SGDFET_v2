                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-hover-animate="pulse" href="{{ ('/') }}" style="color: rgb(255,255,255);font-size: 16px;">Inicio</a>
                            </li>
...
<section style="max-width: 100%;padding: 20px;margin-bottom:40px">
    <div class="container shadow " style="padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
        <div class="row d-flex" style="padding-top: 20px;padding-bottom: 0px;margin-top: 20px;">
        ...
        <div class="row no-gutters text-justify align-items-sm-center" style="padding-top: 10px;padding-bottom: 5px;max-width: 100%;padding-right: 20px;padding-left: 40px;">
            ...
            <div class="col show-monografia">
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fas fa-user-alt"></i>&nbsp;<strong>Autor:</strong> {{$monografias->autor}}</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fas fa-book-open"></i>&nbsp;<strong>Tema:</strong> {{$monografias->tema}}</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fas fa-book-open"></i>&nbsp;<strong>Curso:</strong> {{$monografias->curso}}&nbsp;</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fas fa-book-open"></i>&nbsp;<strong>Nivel:</strong> {{$monografias->nivel}}&nbsp;</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fas fa-user-alt"></i>&nbsp;<strong>Supervisor:</strong> {{$monografias->supervisor}}&nbsp;</p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450"><i class="fa fa-calendar"></i>&nbsp;<strong>Data:</strong> {{date('d/m/y', strtotime($monografias->created_at))}}</p>
                ...
                <div class="modal fade centro" role="dialog" tabindex="-1" id="modal-1">
                    <div class="modal-dialog" style="max-width:1000px;" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #0674a3;">
                                <div class="rounded d-flex align-items-center">
                                    <h6 style="color: #ffffff; margin-right:20px">Monografia de {{$monografias->autor}}</h6>
                                    <form method="post" id="form-download">
                                        @csrf
                                        <a class="btn btn-secondary text-white border rounded d-flex align-items-center" href="/monografia/download/{{$monografias->id}}" id="enviar" data-bs-hover-animate="tada" style="background-color: #68c7ef;">
                                            <ion-icon name="cloud-download" style="color:#ffffff"></ion-icon>&nbsp;Download
                                        </a>
                                    </form>
                                </div>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class="modal-body">
                                <div style="align-content:center;">
                                    <?php
                                    $pdfFilePath = "ficheiros/estudantes/monografias/$monografias->ficheiro";
                                    $parser = new Smalot\PdfParser\Parser();
                                    $pdf = $parser->parseFile($pdfFilePath);
                                    $text = $pdf->getText();
                                    echo nl2br($text);
                                    ?>
                                    <!--<embed style="height: 700px; border:none;" src="/ficheiros/estudantes/monografias/{{$monografias->ficheiro}}" type="application/pdf" width="100%" height="100%">-->
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <a class="btn btn-sm align-items-center text-white btn-participar" data-bs-hover-animate="tada" data-toggle="modal" type="button" data-target="#modal-1" type="button">
                    <i class="fa fa-file-pdf-o"></i>&nbsp;Ficheiro
                </a>
                <script type="text/javascript">
                    $(document).ready(function() {
                        $('#enviar').click(function() {
                            var form = new FormData($("#form-download")[0]);
                            $.ajax({
                                url: '/monografia/join/{{$monografias->id}}',
                                type: 'post',
                                cache: false,
                                processData: false,
                                contentType: false,
        ...
        <div class="row show-monografia-1">
