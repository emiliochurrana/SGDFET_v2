    ...
    <div class="container border rounded shadow" style="padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
        <div class="row" style="padding-top: 0px;padding-bottom: 0px;margin-top: 20px;">
            <div class="col-xl-10 offset-xl-0" style="height: 40px;">
                <h3 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #68c7ef;margin-left: 20px;">{{$visitante->userVisitante->name}}</h3>
            </div>
            <div class="col-xl-2" style="height: 40px;">
                <div class="form-group d-flex justify-content-end align-items-end" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="margin-right: 25px;">
                    <a class="btn btn-sm d-flex align-items-center text-white shadow btn-actualizar" href="/usuario/editperfilvisitante/{{$visitante->userVisitante->id}}" type="button"><ion-icon name="create"></ion-icon>Editar Perfil</a>
                </div>
            </div>
        ...
        <div class="row no-gutters text-justify align-items-sm-center" style="padding: 40px;padding-top: 10px;padding-bottom: 5px;max-width: 100%;">
            <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;">
                <img class="border rounded-circle img-perfilver" src="/ficheiros/visitantes/fotos/{{$visitante->foto}}">
            </div>
            <div class="col text-left" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;padding-bottom: 0px;">
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">
                    ...
                    <span style="color:#2391bf"><strong>Nome:</strong></span> {{$visitante->userVisitante->name}}
                </p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">
                    <i class="fas fa-user-circle" style="color: #68c7ef;font-size: 18px;"></i>&nbsp;
                    <span style="color:#2391bf"><strong>Nome do usuario:</strong></span> {{$visitante->userVisitante->username}}
                </p>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">
                    <i class="fas fa-envelope fa-fw" style="color: #68c7ef;font-size: 18px;"></i>&nbsp;
                    <span style="color:#2391bf"><strong>E-mail:</strong></span> {{$visitante->userVisitante->email}}&nbsp;
                </p>
            </div>
        </div>
    </div>
