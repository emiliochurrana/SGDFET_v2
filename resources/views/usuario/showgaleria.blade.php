    ...
    <div class="container border rounded shadow" style="padding-bottom: 0px;max-width: 100%;padding-right: 0px;padding-left: 0px;">
        <div class="row" style="padding-top: 0px;padding-bottom: 0px;margin-top: 20px;">
            <div class="col-xl-8 offset-xl-0">
                <h3 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #3ba2dc;margin-left: 20px;">Detalhes da imagem</h3>
            </div>
            <div class="col d-flex justify-content-end align-items-center align-content-center" style="padding-right: 40px;">
                <a class="btn btn-sm d-flex align-items-center text-white btn-actualizar" href="{{('/inicio')}}" type="button"><ion-icon name="arrow-undo"></ion-icon></ion-icon>&nbsp;Voltar</a>
            </div>
        </div>
        ...
        <div class="row no-gutters text-justify" style="padding-top: 10px;padding-bottom: 5px;max-width: 100%;padding-left: 40px;padding-right: 30px;">
            <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;padding-bottom:30px;">
                <img class="rounded img-fluid" style="background-size: cover;" src="/ficheiros/galeria/{{$galeria->foto}}" width="300px" height="300px">
            </div>
            <div class="col" style="height: 100%;padding-bottom: 0px;">
                <h5 data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-family: Roboto, sans-serif;color: #000000;"><i class="fas fa-book-open" style="color: #68c7ef;"></i>&nbsp;<strong style="color:#68c7ef;">Titulo:</strong> {{$galeria->titulo}}</h5>
                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;"><i class="fa fa-calendar" style="color: #68c7ef;"></i>&nbsp;<strong style="color:#68c7ef;">Data:</strong> {{date('d/m/y', strtotime($galeria->updated_at))}}</p>
            </div>
        </div>
