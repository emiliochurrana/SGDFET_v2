                ...
                <div class="card shadow">
                    ...
                    <form style="padding: 40px;padding-top: 10px;" role="form" action="{{ ('/usuario/estudante') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" autofocus="" autocomplete="on" required="" placeholder="Nome completo" style="background-color: #ffffff;margin-right: 20px;" name="name">
                            <label style="margin-right: 5px;">Regime*</label>
                            <select class="shadow form-control" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="regime" style="background-color: #ffffff;" required="">
                        ...
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <input class="shadow form-control" type="email" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="margin-right: 20px;background-color: #ffffff;" name="email" autocomplete="on" required="" placeholder="exemplo@gmail.com">
                            <label style="margin-right: 5px;width: 440px;">Numero do estudante*</label>
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="num_estudante" placeholder="Numero do estudante" style="background-color: #ffffff;">
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center">
                            <label style="margin-right: 5px;">Curso*</label>
                            <input class="shadow form-control" value="{{auth()->user()->docenteUser->curso}}" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="margin-right: 20px;background-color: #ffffff;" name="curso" autocomplete="on" required="" placeholder="exemplo@gmail.com">
                            <label style="margin-right: 5px;width: 320px;">Ano de ingresso*</label>
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="ano_ingresso" placeholder="Numero do estudante" style="background-color: #ffffff;">
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center">
                            <label style="margin-right: 5px;">Senha*</label>
                            <input class="shadow form-control" type="password" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" placeholder="Senha" name="password" style="background-color: #ffffff;margin-right: 20px;" required="">
                            <label style="margin-right: 5px;width: 330px;">Confirmar Senha*</label>
                            <input class="shadow form-control" type="password" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="background-color: #ffffff;" name="confirm_password" placeholder="Reedigitar a senha" required="">
                        </div>
                        <div class="form-group">
                            <label style="margin-right: 5px;">Supervisor*</label>
                            <input class="shadow form-control" value="{{auth()->user()->name}}" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="supervisor" style="background-color: #ffffff;">
                        </div>
                        ...
                        <div class="form-group d-flex justify-content-end align-items-center">
                            ...
                            <a class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" href="{{ ('/usuario/estudantes') }}" style="background-color: #da2d22;color: #ffffff;">Cancelar</a>
                        </div>
