        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="card shadow">
                    ...
                    <form style="padding: 40px;" method="post" action="/galeria/update/{{$galeria->id}}" enctype="multipart/form-data" role="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-end align-items-end">
                            ...
                            <a class="btn btn-sm d-flex align-items-center shadow btn-cancelar" data-aos="fade-right" data-aos-duration="800" href="{{('/galeria')}}" data-aos-delay="800" type="button"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</a>
                        </div>
                    </form>
