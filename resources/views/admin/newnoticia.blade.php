        ...
        <div id="content">
                ...
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow" role="presentation">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline">Valerie Luna</span><img class="border rounded-circle img-profile" src="../assets/img/avatars/avatar1.jpeg"></a>
            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <h2 data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="margin-bottom: 0px;color: #3ba2dc;margin-top: 20px;margin-right: 20px;margin-left: 20px;">Nova Noticia</h2>
                    <hr style="background-color: #3ba2dc;margin-top: 5px;">
                    <div class="alert alert-success beautiful" role="alert" style="width: 100%;background-color: rgb(254,163,163);padding-top: 7px;padding-bottom: 7px;"><Strong>Erro!</Strong> Ao cadastrar uma nova noticia.</div>
                    <form style="padding: 40px;padding-top: 10px;">
                        <div class="form-group" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800">
                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Imagem*</span><span class="fileinput-exists">Change</span><input type="file" name="foto"></span>
                                <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                                <div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div>

                            </div>
                        </div>
                        <div class="form-group d-flex"><label style="margin-right: 5px;">Titulo*</label><input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="titulo_noticia" placeholder="Titulo da Noticia" autofocus="" autocomplete="on" required="" style="background-color: #ffffff;margin-right: 20px;"><label class="text-nowrap" style="margin-right: 5px;">Data da&nbsp;Publicação*<br></label><input class="shadow form-control" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" type="month" name="data_noticia" required="" style="background-color: #ffffff;"></div>
                        <div class="form-group d-flex"><label style="margin-right: 5px;">Descrição*<br></label><textarea class="shadow form-control" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" placeholder="Descrição da noticia" name="decricao" autofocus="" style="background-color: #ffffff;"></textarea></div>
                        <div class="form-group d-flex"><label style="margin-right: 5px;">Link</label><input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" autofocus="" placeholder="Link de subucidio de noticia" name="link_noticia" style="background-color: #ffffff;"></div>
                        <div class="form-group d-flex justify-content-end align-items-center">
                            <button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="submit" style="margin-right: 20px;background-color: #0ccf94;color: rgb(248,248,248);"><ion-icon name="add"></ion-icon>&nbsp;Cadastrar</button>
                            <button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="reset" style="background-color: rgb(63,155,195);margin-right: 20px;color: rgb(254,254,254);">Limpar Campos</button>
                            <button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" style="background-color: #da2d22;color: rgb(255,255,255);"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</button>
                        </div>
                        <label class="d-flex" style="margin-top: 20px;padding: 10px;padding-left: 20px;background-color: #aff5ff;">Obs.1: O * representa campos obrigatórios.<br></label>
                        <label class="d-flex" style="margin-top: 20px;padding: 10px;padding-left: 20px;background-color: #aff5ff;">Obs.2:&nbsp; Imagem tem de ter as dimensões: 400px:509px.<br></label>
                    </form>
                </div>
            </div>
        </div>
