            ...
            <div class="container-fluid">
                <div class="card shadow">
                    ...
                    <form style="padding: 40px;padding-top: 10px;">
                        ...
                        <div class="form-group d-flex justify-content-end align-items-center"><button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="submit" style="margin-right: 20px;background-color: #0ccf94;color: rgb(248,248,248);">Cadastrar</button><button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="reset" style="background-color: rgb(63,155,195);margin-right: 20px;color: rgb(254,254,254);">Limpar Campos</button><button class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" style="background-color: #da2d22;color: rgb(255,255,255);">Cancelar</button></div><label class="d-flex" style="margin-top: 20px;padding: 10px;padding-left: 20px;background-color: #aff5ff;">Obs.1: O * representa campos obrigatórios.<br></label>
