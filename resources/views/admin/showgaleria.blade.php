                ...
                <div class="card shadow">
                    <div class="row" style="padding-top: 0px;padding-bottom: 0px;margin-top: 20px;margin-bottom:20px">
                        <div class="col-xl-8 offset-xl-0">
                            <h3 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #3ba2dc;padding-left: 20px;">Detalhes da Imagem</h3>
                        </div>
                        <div class="col d-flex justify-content-end align-items-center align-content-center" style="padding-right: 40px;">
                            @if(auth()->user()->is_drcurso)
                            <a class="btn btn-sm d-flex align-items-center text-white btn-actualizar" href="/galeria/edit/{{$galeria->id}}" type="button"><ion-icon name="create"></ion-icon>&nbsp;Editar</a>
                            <a class="btn btn-sm d-flex align-items-center text-white btn-cancelar" href="{{('/galeria')}}" type="button"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</a>
                            @elseif(auth()->user()->is_admin || auth()->user()->is_docente)
                            <a class="btn btn-sm d-flex align-items-center text-white btn-actualizar shadow" data-aos="fade-right" data-aos-duration="800" href="{{('/galeria')}}" data-aos-delay="800" type="button"><ion-icon name="arrow-undo"></ion-icon>&nbsp;Voltar</a>
                            @endif
                        </div>
                    </div>
                    <div class="row no-gutters text-justify" style="padding-top: 10px;padding-bottom: 10px;max-width: 100%;padding-left: 40px;">
                        <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;margin-bottom:25px">
                            <img class="rounded img-galeria-ver" style="background-size: cover;" src="/ficheiros/galeria/{{$galeria->foto}}">
                        </div>
                        <div class="col" style="height: 100%;padding-bottom: 0px;padding-right: 100px;padding-left: 40px;">
                            <h6 data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-family: Roboto, sans-serif;color: #000000;">
                                <i class="fas fa-book-open" style="color: #68c7ef;"></i>&nbsp;<strong style="color: #68c7ef;">Titulo:</strong> {{$galeria->titulo}}
                            </h6>
                            <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">
                                <i class="fa fa-calendar" style="color: #68c7ef;"></i>&nbsp;<strong style="color: #68c7ef;">Data:</strong> {{date('d/m/y', strtotime($galeria->updated_at))}}
                            </p>
                        </div>
                    </div>
                    <div class="row" style="padding-top: 5px;max-width: 100%;padding-right: 20px;padding-left: 20px;">
                        <div class="col-xl-12 offset-xl-0" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="padding-right: 40px;padding-left: 40px;">
                            <h5 style="color: #3ba2dc;font-family: Roboto, sans-serif;font-weight: bold;"><strong>Descrição</strong><br></h5>
                            <p class="text-justify" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-family: Roboto, sans-serif;padding-left: 15px;">{{$galeria->descricao}}<br></p>
                        </div>
                    </div>
                </div>
            </div>
