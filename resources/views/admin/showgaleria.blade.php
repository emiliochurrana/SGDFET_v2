                ...
                <div class="card shadow">
                    <div class="row" style="padding-top: 0px;padding-bottom: 0px;margin-top: 20px;">
                        <div class="col-xl-8 offset-xl-0">
                            <h2 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #3ba2dc;padding-left: 20px;">Detalhes da Imagem</h2>
                        </div>
                    ...
                    <div class="row no-gutters text-justify" style="padding-top: 10px;padding-bottom: 10px;max-width: 100%;padding-left: 40px;">
                        <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;">
                            <img class="rounded img-fluid" style="background-size: cover;" src="/ficheiros/galeria/{{$galeria->foto}}" width="300px" height="100px">
                        </div>
                        <div class="col" style="height: 100%;padding-bottom: 0px;padding-left: 20px;">
                            <h6 data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="font-weight: bold;font-family: Roboto, sans-serif;color: #000000;">
                            <i class="fas fa-book-open" style="color: #68c7ef;"></i>&nbsp;Titulo: {{$galeria->titulo}}</h6>
                            <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">
                            <i class="fa fa-calendar" style="color: #68c7ef;"></i>&nbsp;Data:  {{date('d/m/y', strtotime($galeria->data))}}</p>
                        </div>
                    </div>
                    <div class="row" style="padding-top: 5px;max-width: 100%;padding-right: 20px;padding-left: 20px;">
                        <div class="col-xl-12 offset-xl-0" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="padding-right: 40px;padding-left: 40px;">
                            <h6 style="color: #3ba2dc;font-family: Roboto, sans-serif;font-weight: bold;"><strong>Descrição</strong><br></h6>
