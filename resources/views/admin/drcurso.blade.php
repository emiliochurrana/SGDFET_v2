            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <div class="card-header py-3 d-md-flex d-lg-flex d-xl-flex">
                        ...
                        <p class="" style="color:#2694c1;font-size:14px"><strong>A FET lecciona um total de {{count($drcurso)}} cursos</strong></p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-5 offset-xl-0 justify-content-end align-items-center" style="width: 100%;">
                                <form method="get" action="{{ ('/usuario/drcursos') }}" enctype="multipart/form-data">
                                    <div class="text-md-right justify-content-start align-items-center dataTables_filter" id="dataTable_filter" style="width: 100%;padding-right: 10px;padding-left: 10px;height: 50px;">
                                        <label style="width: 100%;">
                                            <input class="border rounded border-primary shadow form-control form-control-sm" type="search" aria-controls="dataTable" id="search" placeholder="Pesquisar dr. do curso pelo nome..." style="padding-bottom: 0px;height: 40px;" autocomplete="on" name="search">
                                        </label>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-7 offset-xl-0 d-flex justify-content-end align-items-center">
                                <div class="btn-group" role="group">
                                    <a class="btn border rounded" role="button" style="background-color: #3ba2dc;height: 40px;color: #ffffff;" href="{{ route('newdrcurso') }}"><i class="fas fa-user-plus"></i>&nbsp; Novo Dr. Curso<br></a>
                                </div>
                            </div>
                        </div>
                        <main>
                        ...
                        <div class="table-responsive" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center" style="color: #3a3a3b;min-width:200px"><img class="rounded-circle img-perfil" src="/ficheiros/docentes/fotos/{{$user->drcursoUser->foto}}" width="40px" style="margin-right: 10px;" height="40px">{{$user->name}}</td>
                                        ...
                                        <td>
                                            <div class="col d-flex align-items-start align-content-start">
                                                <a class="btn btn-sm d-flex align-items-center" type="button" href="/usuario/editdrcurso/{{$user->id}}" style="background-color: #0ccf94;color: rgb(242,244,245);margin-right: 10px;margin-top: 6px;"><ion-icon name="create"></ion-icon>&nbsp;Editar</a>
                                                ...
                                                <a class="btn btn-sm d-flex align-items-center" type="button" href="/usuario/showdrcurso/{{$user->id}}" style="background-color: #0280c6;color: rgb(243,246,248);margin-top: 6px;"><ion-icon name="eye"></ion-icon>&nbsp;Ver</a>
                            ...
                            <div class="container-fluid">
                                @if(count($drcurso) == 0 && $search)
                                <p class="msg" style="color:#2390be;"><Strong>Não existe Dr. de Curso com o nome {{$search}}!</Strong><a style="font-size:16px" href="{{ ('/usuario/drcursos') }}"> Ver todos Dr. de Curso</a></p>
                                @elseif(count($drcurso) == 0)
                                <p class="msg"><Strong>Nenhum Dr. de curso cadsatrado</Strong></p>
                                @endif
                            </div>
