                ...
                <div class="card shadow">
                    ...
                    <form class="needs-validation" style="padding: 30px;padding-top: 10px;" role="form" method="post" action="{{ route('storemonografia') }}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-end align-items-center">
                            <button class="btn btn-sm d-flex align-items-center text-white btn-actualizar shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="submit"><ion-icon name="add"></ion-icon>&nbsp;Cadastrar</button>
                            ...
                            <a class="btn btn-sm d-flex align-items-center text-white btn-cancelar shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" href="{{ ('/monografias/index') }}"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</a>
                        </div>
