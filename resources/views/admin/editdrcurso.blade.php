                    ...
                    <div class="card shadow">
                        ...
                        <form style="padding: 40px;" action="/usuario/updatedrcurso/{{$drcurso->userDrcurso->id}}" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group d-flex justify-content-center align-items-center">
                                ...
                                <input class="shadow form-control" style="margin-right: 5px;" type="text" value="{{$drcurso->userDrcurso->name}}" name="name" style="background-color: #ffffff;">
                                <label style="margin-right: 5px;color: #000000;">Curso</label>
                                <input class="shadow form-control" type="text" value="{{$drcurso->userDrcurso->curso}}" name="name" style="background-color: #ffffff;">
                            </div>
                            <div class="form-group d-flex justify-content-center align-items-center">
                                <label style="margin-right: 5px;color: #000000;">Email</label>
                                <input class="shadow form-control" type="email" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" value="{{$drcurso->userDrcurso->email}}" name="email" autocomplete="on" style="margin-right: 20px;background-color: #ffffff;">
                                <label style="margin-right: 5px;color: #000000;">Usuário<br></label>
                                <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" value="{{$drcurso->userDrcurso->username}}" name="username" style="background-color: #ffffff;">
                            </div>
                            <div class="form-group d-flex justify-content-center align-items-center">
                                <label style="margin-right: 5px;color: #000000;">Senha</label>
                            ...
                            <div class="form-group d-flex justify-content-center align-items-center">
                                <label style="margin-right: 5px;width: 140px;color: #000000;">Confirmar Senha</label>
                            ...
                            <div class="form-group">
                                <div class="form-check" style="padding-bottom: 10px;">
                                    <input class="form-check-input" type="checkbox" id="formCheck-1" name="is_active" <?php if ($drcurso->userDrcurso->is_active) {
                                                                                                                    echo "checked";
                                                                                                                } ?>>
                                    <label class="form-check-label" for="formCheck-1" style="color: #999999;">Activo</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="formCheck-2" name="is_drcurso" <?php if ($drcurso->userDrcurso->is_drcurso) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>>
                            ...
                            <div class="form-group d-flex justify-content-end align-items-end">
                                ...
                                <a class="btn shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" href="{{('/usuario/drcursos')}}" style="background-color: #da2d22;color: #ffffff;">Cancelar</a>
