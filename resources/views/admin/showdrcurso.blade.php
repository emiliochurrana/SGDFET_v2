                ...
                <div class="card shadow">
                    <div class="row" style="padding-top: 0px;padding-bottom: 0px;margin-top: 20px;">
                        <div class="col-xl-9 offset-xl-0" style="height: 40px;">
                            <h2 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #68c7ef;margin-left: 20px;">&nbsp;{{$drcurso->userDrcurso->name}}</h2>
                        </div>
