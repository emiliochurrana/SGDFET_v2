        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <h3 data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="margin-bottom: 15px;color: #3ba2dc;padding-left: 20px;padding-right: 20px;padding-top: 10px;">Editar {{$noticias->titulo}}</h3>
                    ...
                    <form style="padding: 40px;" method="post" action="/noticia/update/{{$noticias->id}}" enctype="multipart/form-data" role="form">
                        ...
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                            ...
                            <div class="d-flex shadow justify-content-center align-items-center fileinput fileinput-new input-group" data-aos="zoom-in" id="password" data-aos-duration="800" data-aos-delay="800" for="foto" style="background-color: #ffffff;" data-provides="fileinput">
                                <input class="form-control  file-input" accept="image/*" value="{{$noticias->foto}}" type="file" id="foto" name="foto">{{$noticias->foto}}
                        ...
                        <div class="form-group d-lg-flex d-xl-flex">
                            ...
                            <input class="shadow form-control" value="" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" type="date" name="data" style="background-color: #ffffff;">-->
                        </div>
                        <div class="form-group d-lg-flex d-xl-flex">
                            <label style="margin-right: 5px;color: #000000;">Descrição<br></label>
                            <textarea class="shadow form-control form-control-sm" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" name="descricao" style="background-color: #ffffff;">{{$noticias->descricao}}</textarea>
                        </div>
                        <div class="form-group d-lg-flex d-xl-flex">
                            <label style="margin-right: 5px;color: #000000;">Link</label>
                            <input class="shadow form-control" type="text" value="{{$noticias->link}}" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" autofocus="" name="link" style="background-color: #ffffff;">
                        </div>
                        <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-end align-items-end">
                            ...
                            <a class="btn btn-sm d-flex align-items-center shadow btn-cancelar" data-aos="fade-right" href="{{('/noticias')}}" data-aos-duration="800" data-aos-delay="800" type="button"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</a>
                        </div>
                    </form>
