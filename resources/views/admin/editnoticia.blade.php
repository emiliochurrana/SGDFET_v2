                ...
                <div class="card shadow">
                    ...
                    <form style="padding: 40px;" method="post" action="/noticia/update/{{$noticias->id}}" enctype="multipart/form-data" role="form">
                        ...
                        <div class="form-group" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800">
                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                <span class="input-group-addon btn btn-default btn-file">
                                    ...
                                    <input type="file" value="{{$noticias->foto}}" accept="image/*" name="foto">{{$noticias->foto}}
                                </span>
                                <a href="/ficheiros/noticias/{{$noticias->foto}}" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                        ...
                        <div class="form-group d-flex justify-content-end align-items-end">
                            ...
                            <a class="btn shadow" data-aos="fade-right" href="{{('/noticias')}}" data-aos-duration="800" data-aos-delay="800" type="button" style="background-color: #da2d22;color: #ffffff;">Cancelar</a>
                        </div>
                    </form>
