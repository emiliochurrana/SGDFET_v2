            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <h3 data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="color: #3ba2dc;margin-top: 20px;margin-right: 20px;margin-bottom: 0px;margin-left: 20px;">Novo Docente<br></h3>
                        ...
                        <form class="needs-validation" style="padding: 30px;" method="post" role="form" action="{{ route('storedocente') }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                                ...
                                <input class="@error('name') is-invalid @enderror shadow form-control" type="text" data-aos="zoom-in" id="name" required data-aos-duration="800" data-aos-delay="800" autofocus="" autocomplete="on" placeholder="Nome Completo" style="background-color: #ffffff;" name="name">
                            </div>
                            ...
                            <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                                ...
                                <input class="@error('email') is-invalid @enderror shadow form-control" type="email" data-aos="zoom-in" id="email" pattern="^[a-zA-Z0-9_.-@]*$" data-aos-duration="800" data-aos-delay="800" name="email" required placeholder="exemplo@gmail.com" style="background-color: #ffffff;margin-right: 10px;margin-bottom:10px" autocomplete="on">
                                <label style="margin-right: 5px;">Curso*</label>
                                <input class="@error('curso') is-invalid @enderror shadow form-control" value="{{auth()->user()->drcursoUser->curso}}" type="text" id="curso" data-aos="zoom-in" required data-aos-duration="800" data-aos-delay="800" name="curso" style="background-color: #ffffff;margin-right: 10px;">
                            </div>
                            <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center">
                                <label style="margin-right: 5px;">Senha*</label>
                                <input class="@error('password') is-invalid @enderror shadow form-control" type="password" data-aos="zoom-in" data-aos-duration="800" id="password" required minlength="6" data-aos-delay="800" placeholder="Senha" name="password" style="background-color: #ffffff;margin-right: 20px;margin-bottom:10px">
                            ...
                            <div class="form-group d-md-flex d-lg-flex d-xl-flex justify-content-end align-items-center">
                                ...
                                <a class="btn btn-sm d-flex align-items-center btn-cancelar shadow" data-aos="fade-right" data-aos-duration="800" data-aos-delay="800" type="button" href="{{ ('/usuario/docentes') }}"><ion-icon name="close-outline"></ion-icon>&nbsp;Cancelar</a>
                            </div>
