            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <div class="card-header py-3">
                        <h2 class="d-xl-flex mr-auto" style="color: #3ba2dc;font-family: Roboto, sans-serif;">Galeria</h2>
                    </div>
                    @if(auth()->user()->is_drcurso)
                    <main>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col d-flex justify align-items-start align-content-start">
                                                @if(auth()->user()->is_drcurso)
                                                <a class="btn btn-sm d-flex align-items-center btn-actualizar" type="button" href="/galeria/edit/{{$galeria->id}}"><ion-icon name="create"></ion-icon>&nbsp;Editar</a>
                                                @endif
                                                <a class="btn btn-sm d-flex align-items-center btn-ver" href="/galeria/show/{{$galeria->id}}" type="button"><ion-icon name="eye"></ion-icon>&nbsp;Ver</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
