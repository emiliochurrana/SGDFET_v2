                            ...
                            <div class="table-responsive" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="d-flex align-items-center" style="color: #3a3a3b;"><img class="rounded-circle" src="{{$defesa->foto}}" width="40px" style="margin-right: 10px;" height="40px">{{$defesa->estudanteDefesa->name}}</td>
                                            ...
                                            <td>
                                                <div class="col d-flex justify-content-end align-items-start align-content-start">
                                                    @if(auth()->user()->is_drcurso)
                                                    <a class="btn btn-sm" href="/defesa/edit/{{ $defesa->id }}" type="button" style="background-color: #0ccf94;color: rgb(242,244,245);margin-right: 10px;margin-top: 6px;">Editar</a>
                                                    ...
                                                    @endif
                                                    <a class="btn btn-sm" type="button" href="/defesa/show/{{ $defesa->id }}" style="background-color: #0280c6;color: rgb(243,246,248);margin-top: 6px;">Ver</a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
