                ...
                <div class="card shadow">
                    ...
                    <form style="padding: 40px;padding-top: 10px;">
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" autofocus="" autocomplete="on" required="" placeholder="Nome do Estudante" style="background-color: #ffffff;" name="nome">
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center">
                        ...
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <textarea class="shadow form-control form-control-sm" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" placeholder="Resumo " name="decricao" autofocus="" style="background-color: #ffffff;margin-right: 20px;" required=""></textarea>
                        ...
                        <div class="form-group d-flex justify-content-center align-items-center">
                            ...
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="background-color: #ffffff;margin-right: 20px;" placeholder="Nome do oponente" name="oponente" required="" autocomplete="on">
                            <label style="margin-right: 5px;">Presidente*</label>
                            <input class="shadow form-control" type="text" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800" style="background-color: #ffffff;" name="presidente" placeholder="Nome do presidente" autofocus="" required="">
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center">
