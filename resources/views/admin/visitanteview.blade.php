            ...
            <div class="container-fluid">
                <div class="card shadow">
                    <div class="card-header py-3 d-md-flex d-lg-flex d-xl-flex">
                        <h2 class="d-xl-flex mr-auto" style="color: #3ba2dc;font-family: Roboto, sans-serif;">Visitantes</h2>
                        <p class="" style="color:#2694c1;font-size:14px"><strong>A FET tem um total de {{count($visitantes)}} visitantes</strong></p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-5 offset-xl-0 justify-content-end align-items-center" style="width: 100%;">
                                <form method="get" action="{{ ('/usuario/visitante') }}" enctype="multipart/form-data">
                                    <div class="text-md-right justify-content-start align-items-center dataTables_filter" id="dataTable_filter" style="width: 100%;padding-right: 10px;padding-left: 10px;height: 50px;">
                                        <label style="width: 100%;">
                                            <input class="border rounded border-primary shadow form-control form-control-sm" type="search" aria-controls="dataTable" id="search" placeholder="Pesquisar visitante pelo nome..." style="padding-bottom: 0px;height: 40px;" autocomplete="on" name="search">
                                        </label>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="table-responsive" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center" style="color: #3a3a3b;min-width:200px"><img class="rounded-circle img-perfil" src="/ficheiros/visitantes/fotos/{{$user->visitanteUser->foto}}" style="margin-right: 10px;">{{$user->name}}</td>
                                        <td style="color: #3a3a3b;">{{$user->email}}</td>
                                        <td style="color: #3a3a3b;">{{$user->username}}</td>
                                        <td>@if($user->is_visitante)<i class="fa fa-check" style="color: #3a3a3b;margin-top: 6px;"></i>@endif</td>
                                        <td>
                            ...
                            <div class="container-fluid">
                                @if(count($visitantes) == 0 && $search)
                                <p class="msg" style="color:#2390be;"><Strong>Não existe visitante com o nome {{$search}}!</Strong><a style="font-size:16px" href="{{ ('/usuario/visitante') }}"> Ver todos visitantes</a></p>
                                @elseif(count($visitantes) == 0)
                                <p class="msg"><Strong>Nenhum visitante cadsatrado</Strong></p>
                                @endif
                            </div>
