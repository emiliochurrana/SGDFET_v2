        ...
        <div class="fixed-left">    
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    @endif
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" href="{{ ('/comentarios') }}"><i class="fa fa-comments-o"></i><span>Comentarios</span></a>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex">
                            <h2 class="d-xl-flex mr-auto" style="color: #3ba2dc;font-family: Roboto, sans-serif;">Comentários</h2>
                            <p class="" style="color:#2694c1;font-size:14px"><strong>Existe um total de {{count($comentarios)}} comentários</strong></p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: #2694c1;"><strong>E-mail</strong></th>
                                            <th style="color: #2694c1;"><strong>Mensagem</strong></th>
                                            <th style="color: #2694c1;"><strong>Estudante</strong></th>
                                            <th style="color: #2694c1;"><strong>Visitante</strong></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: #3a3a3b;">{{$comentario->email}}</td>
                                            <td style="color: #3a3a3b;">{{$comentario->mensagem}}</td>
                                            <td>@if($comentario->is_estudante)<i class="fa fa-check" style="color: #3a3a3b;margin-top: 6px;"></i>@endif</td>
                                            <td>@if($comentario->is_visitante)<i class="fa fa-check" style="color: #3a3a3b;margin-top: 6px;"></i>@endif </td>
                                            <td style="color: #3a3a3b;"> {{date('d/m/y', strtotime($comentario->created_at))}}</td>
                                            <td>
                                                @if(auth()->user()->is_drcurso || auth()->user()->is_admin)
