                ...
                <div class="card shadow">
                    <div class="row">
                        <div class="col" style="padding-bottom: 12px;">
                            <div>
                                <h3 class="dropdown-header" style="background-color: #74d0f6;color: #ffffff;font-size: 20px;font-weight: bold;">Notificações<br></h3>
                                <a class="d-flex align-items-center dropdown-item" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <span class="small text-gray-500">December 12, 2019</span>
                                        <p style="font-size: 14px;"><strong>A new monthly report is ready to download!</strong></p>
                                    </div>
                                </a>
                                <a class="d-flex align-items-center dropdown-item" href="#">
                                    <div class="mr-3">
                                ...
                                <a class="d-flex align-items-center dropdown-item" href="#">
                                    ...
                                    <div>
                                        <span class="small text-gray-500">December 12, 2019</span>
                                        <p style="font-size: 14px;"><strong>Spending Alert: We've noticed unusually high spending for your account.</strong><br></p>
                                    </div>
                                </a>
                            </div>
                        </div>
