                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-7 offset-xl-0 d-flex justify-content-end align-items-center">
                                ...
                                <div class="btn-group" role="group">
                                    <a class="btn border rounded d-xl-flex align-items-xl-center" role="button" style="background-color: #3ba2dc;height: 40px;color: #ffffff;" href="{{('/monografia/store')}}">
                                        <i class="material-icons">library_books</i>&nbsp; Nova Monografia<br></a>
                                </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="color: #3a3a3b;">Tema</th>
                                        <th style="color: #3a3a3b;">Curso</th>
                                        <th style="color: #3a3a3b;">Nivel</th>
                                        <th style="color: #3a3a3b;">Supervisor</th>
                                        <th style="color: #3a3a3b;">Data/Hora</th>
                                        @if(auth()->user()->is_drcurso)
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center" style="color: #3a3a3b;"><img class="rounded-circle" src="{{$mono->foto}}" width="40px" style="margin-right: 10px;" height="40px">{{$mono->name}}</td>
                                        ...
                                        <td style="color: #3a3a3b;">{{$mono->data}}</td>
                                        <td>
                                            <div class="col d-flex justify-content-end align-items-center align-content-center">
                                                @if(auth()->user()->is_drcurso)
                                                <button class="btn btn-sm" type="button" haref="/monografia/edit/{{$mono->id}}" style="background-color: #0ccf94;color: rgb(242,244,245);margin-right: 10px;margin-top: 6px;">Editar</button>
                                                ...
                                                @endif
                                                <a class="btn btn-sm" type="button" haref="/monografia/show/{{$mono->id}}" style="background-color: #0280c6;color: rgb(243,246,248);margin-top: 6px;">Ver</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
