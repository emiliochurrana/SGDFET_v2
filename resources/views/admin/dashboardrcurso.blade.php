...
<div id="wrapper">
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow" role="presentation">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">
                                    ...
                                    <img class="border rounded-circle img-perfil" src="/ficheiros/docentes/fotos/{{auth()->user()->drcursoUser->foto}}"></a>
                        ...
                        <div class="card shadow border-left-warning py-2" style="background-color: #819ef2;">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-center text-warning font-weight-bold text-xs mb-1" style="color: #0e56e1;">
                                            <span style="color: #ffffff;font-size: 12px;">Total Estudantes Inscritos&nbsp;&nbsp;</span>
                                        </div>
                        ...
                        <div class="card shadow border-left-warning py-2" style="background-color: #1e96c9;">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-center text-warning font-weight-bold text-xs mb-1" style="color: #0e56e1;">
                                            <span style="color: #ffffff;font-size: 12px;">Total Docentes Inscritos&nbsp;&nbsp;</span>
                                        </div>
                                        <div class="text-center text-dark font-weight-bold h5 mb-0">
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2" style="background-color: #06c8e4;">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-center text-warning font-weight-bold text-xs mb-1" style="color: #06c8e4;">
                                            <span style="color: #ffffff;font-size: 12px;">Total Defesas marcadas&nbsp;&nbsp;</span>
                                        </div>
                                        <div class="text-center text-dark font-weight-bold h5 mb-0">
                        ...
                        <div class="card shadow border-left-warning py-2" style="background-color: #0e56e1;">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-center text-warning font-weight-bold text-xs mb-1" style="color: #0e56e1;">
                                            <span style="color: #ffffff;font-size: 12px;">Total Monografias publicadas&nbsp;&nbsp;</span>
                                        </div>
                                        <div class="text-center text-dark font-weight-bold h5 mb-0">
    ...
    //passa o timestamp atual para a função step
      ...
      const load = () => {
         animate(text1, 0, '{{count($estudantes)}}', 2000);
         animate(text2, 0, '{{count($docentes)}}', 2000);
         animate(text3, 0, '{{count($defesas)}}', 2000);
         animate(text4, 0, '{{count($monografias)}}', 2000);
      }
   </script>
                <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="chart-area">
                                    <canvas data-bs-chart="{&quot;type&quot;:&quot;doughnut&quot;,&quot;data&quot;:{&quot;labels&quot;
                                            ...
                                            :[{&quot;label&quot;:&quot;&quot;,&quot;backgroundColor&quot;
                                                :[&quot;#819ef2&quot;,&quot;#1cc88a&quot;,&quot;#36b9cc&quot;,&quot;#0e56e1&quot;],&quot;borderColor&quot;
                                ...
                                <div class="text-center small mt-4">
                                    <span class="mr-2"><i class="fas fa-circle" style="color:#819ef2"></i>&nbsp;Estudantes</span>
