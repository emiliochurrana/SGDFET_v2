                ...
                <div class="card shadow">
                    <div class="row" style="padding-top: 20px;padding-bottom: 0px;">
                        <div class="col-xl-10 offset-xl-0" style="height: 40px;">
                            <h2 data-aos="zoom-in" data-aos-duration="400" data-aos-delay="400" style="font-family: Roboto, sans-serif;font-weight: bold;color: #68c7ef;padding-left: 20px;">Perfil [nome docente]</h2>
                        </div>
                        <div class="col-xl-2" style="height: 40px;">
                            <div class="form-group d-flex justify-content-end align-items-end" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="padding-right: 20px;"><button class="btn" type="button" style="color: rgb(255,255,255);background-color: #0ccf94;">Editar Perfil</button></div>
                        </div>
                    ...
                    <div style="padding: 40px;padding-top: 10px;">
                        <div class="row no-gutters text-justify align-items-sm-center" style="padding-top: 10px;padding-bottom: 5px;max-width: 100%;">
                            <div class="col-xl-4 offset-xl-0 d-xl-flex align-items-sm-center align-items-md-center align-items-lg-center justify-content-xl-center align-items-xl-center" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;"><img class="rounded-circle img-fluid" style="background-size: cover;" src="../assets/img/img-1.jpg" width="270px"></div>
                            <div class="col" data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="height: 100%;padding-bottom: 0px;">
                                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">Nome: Emilio Jose Churrana</p>
                                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">Nome do usuario: 01.1732.2018</p>
                                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">Curso: Informatica</p>
                                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">E-mail: emiliochurrana@icloud.com&nbsp;</p>
                            </div>
                        </div>
                        <div class="row" style="padding-top: 5px;max-width: 100%;">
                            <div class="col offset-xl-0">
                                <p data-aos="zoom-in" data-aos-duration="450" data-aos-delay="450" style="color: #000000;">Curriculum:</p>
                            </div>
                        </div>
                    </div>
                </div>
