...
<head>
    ...
    <link rel="stylesheet" href="/../css/Swiper-Slider-Card-For-Blog-Or-Product-1.css">
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAQJdKHOTYvcNyb3vcH84lhItWs-e2Qrsk&libraries=map&callback=initMap">
    </script>
</head>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-5 col-xl-4 offset-xl-0">
                                        <div class="form-group">
                                            <input class="border rounded shadow form-control form-control-sm" type="text" required name="name" placeholder="Nome completo" required="" style="height: 40px;">
                                        </div>
                                        <div class="form-group">
                                            <input class="border rounded shadow form-control form-control-sm" type="email" required placeholder="Email" required="" name="email" autocomplete="on" style="height: 40px;margin-top: 30px;">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-5 offset-xl-0">
                                        <div class="form-group">
                                            <textarea class="border rounded shadow form-control form-control-sm d-xl-flex" required name="mensagem" placeholder="Escreva o seu comentário aqui" autocomplete="on" required="" style="height: 110px;"></textarea>
                                        </div>
                                    </div>
...
<script src="/../js/Swiper-Slider-Card-For-Blog-Or-Product.js"></script>
